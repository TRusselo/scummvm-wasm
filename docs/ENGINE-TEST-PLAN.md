...
## Confirmed working so far (47 of 102, + agos2 subengine bonus)
...
`ultima` (via `ultima8`), `director`, `voyeur`, `asylum`, `buried`, `cryo`. Marked **Confirmed working** in their table row below — search this file for that phrase to
jump to them.
