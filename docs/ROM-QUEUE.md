...
| saga2 | `[test] Faery Tale Adventure II.zip` | archive.org `msdos_Halls_of_the_Dead_-_Faery_Tale_Adventure_II_1997` | **Retest after fix**: missing `SAMPLE.AD`/`SAMPLE.OPL` (hardcoded runtime filenames, not in the detection fingerprint) added at zip root |
