...
cd retroarch
# STACK_SIZE=16777216 (16MB, vs Emscripten's 4MB default)
...
EMCC_CFLAGS="--embed-file ../build/embed-staging/engine-data@/engine-data -g -gsource-map $EXTRA_DEBUG_FLAGS" emmake make -f Makefile.emulatorjs \
  LD=em++ \
